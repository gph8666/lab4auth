#!/usr/bin/env python3
"""
Minutiae Matching with Logistic Regression
Trains on training data and evaluates on testing data using Minutiae Matching features.
...
def extract_features(pairs):
    """Extract Minutiae Matching scores for each pair."""
    features = []
    for file_a, file_b in pairs:
        score = calculate_minutiae_similarity(file_a, file_b)
        features.append([score])  # Single feature for Minutiae Matching
...
if __name__ == "__main__":
    ...
    output_file = "metrics_minutiae_regression.csv"
    ...
    # Print metrics
    print("Minutiae Matching with Logistic Regression Metrics:")
    print(metrics_df)
