#!/usr/bin/env python3
"""
Orientation Field Matching with Logistic Regression
Trains on training data and evaluates on testing data using Orientation Field Matching features.
...
def extract_features(pairs):
    """Extract Orientation Field Matching scores for each pair."""
    features = []
    for file_a, file_b in pairs:
        score = calculate_orientation_similarity(file_a, file_b)
        features.append([score])  # Single feature for Orientation Field Matching
...
if __name__ == "__main__":
    ...
    output_file = "metrics_orientation_regression.csv"
    ...
    # Print metrics
    print("Orientation Field Matching with Logistic Regression Metrics:")
    print(metrics_df)
